...
5. (CAPITAL) "Legal Sr, para você ter uma ideia, a lucratividade está diretamente ao investimento. Tem um monte de franquia dizendo que com apenas 10 mil o Sr vai lucrar 50. E isso não é uma verdade. Qual valor você tem disponível para investir hoje?"

REGRA: Uma pergunta por vez. Se o lead responder a cidade agora, pule para a ATUAÇÃO.
"""
...
def gerar_resposta_ia(phone, mensagem_usuario):
    # GEMINI-2.0-FLASH-LITE: A melhor cota gratuita em Dez/2025
    ...
    try:
        ...
        print(f"Erro IA: {e}")
        # RESPOSTA DE SEGURANÇA QUE MANTÉM O FLUXO
